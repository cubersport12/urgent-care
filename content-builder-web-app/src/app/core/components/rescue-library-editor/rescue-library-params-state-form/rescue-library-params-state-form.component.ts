import { RescueLibraryParamsStateVm } from '@/core/utils';
...
@Component({
  selector: 'app-rescue-library-params-state-form',
  imports: [
    MatIcon,
    MatButton,
    ReactiveFormsModule,
  ...
  templateUrl: './rescue-library-params-state-form.component.html',
  styles: ``
})
export class RescueLibraryParamsStateFormComponent {
  private readonly _dispatched = inject(AppLoading);

  selectedItem = input.required<RescueLibraryParamsStateVm>();
