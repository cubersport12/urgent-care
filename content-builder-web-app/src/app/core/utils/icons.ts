...
import { faSun, faMoon, faPlus, faExclamationCircle, faWindowMaximize, faTrash, faFolder, faSpinner, faCheck, faTimes, faFileContract, faSlidersH, faFileCircleCheck, faVideo } from '@fortawesome/free-solid-svg-icons';
